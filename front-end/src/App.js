...
import AdminChatRoom from './pages/AdminChatRoom/index';
    ...
    <Router>
      <Switch>
        ...
        <Route
          ...
          path="/chat"
          render={() =>
            requireAuth() ? <ChatClient /> : <Redirect to="/login" />
          }
        />
        <Route
          exact
          path="/admin/chats"
          render={() =>
            requireAuth() ? <ChatAdmin /> : <Redirect to="/login" />
          }
        />
        <Route
          path="/admin/chats/:id"
          render={(matchProps) =>
            requireAuth() ? (
              <AdminChatRoom dataFromChatAdmin={matchProps} />
            ) : (
              <Redirect to="/login" />
            )
          }
